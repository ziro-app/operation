...
const sendToBackend = state => () => {
    const {setInputDate,setCodPickup,setProvider,setAdress,setBags,setInvoice,setRomaneio,setObservation,setFilename, reseller, codPickup, inputDate, provider, adress,bags, invoice, romaneio, filename, observation} = state
