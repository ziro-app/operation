...
const UpdateAffiliate = () => {
    ...
    useEffect(() => fetch(setIsLoading, setIsError, setAffiliates), [])
    ...
    return (
        <>
            ...
            {foundAffiliate ? <>
                ...
                />
                <InputEdit
                    name="Unidade da Marca"
                    value={affiliate.unidade}
                    onChange={() => { }}
                    validateInput={() => { }}
                    submit={() => { }}
                    setError={() => { }}
                ...
                <InputEdit
                    ...
                    submit={sendToBackend('C', affiliateRow, newName, setLoadingName, setErrorName)}
                    setError={() => { }}
                    error={errorName}
                    editable={true}
                ...
                <InputEdit
                    ...
                    submit={sendToBackend('D', affiliateRow, newSurname, setLoadingSurname, setErrorSurname)}
                    setError={() => { }}
                    error={errorSurname}
                    editable={true}
                ...
                <InputEdit
                    ...
                    submit={sendToBackend('E', affiliateRow, newWhatsapp, setLoadingWhatsapp, setErrorWhatsapp)}
                    setError={() => { }}
                    error={errorWhatsapp}
