    ...
    try {
          ...
          resource: {
            values: [
              [
                ...
                paymentType,
                imgUrl,
                paymentType === 'TED' ? beneficiary : '',
                paymentType === 'TED' ? bankName : '',
                paymentType === 'TED' ? agencia : '',
                paymentType === 'TED' ? conta : '',
                paymentType === 'TED' ? doc : '',
                obs,
                nickname,
              ],
      ...
      if (type === 'Cartão de Crédito') {
        const docRef = await db.collection('credit-card-payments').add({
          ...
          seller: supplierName,
          onBehalfOfBrand: storeownerName,
          sellerZoopId: '13c09ab817014ae6843634493177afb2',
          charge: totalAmount,
          installmentsMax: `${parseInt(installment)}`,
