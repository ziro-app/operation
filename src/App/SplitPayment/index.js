    ...
    return (
        <div style={containerWithPadding}>
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
                <Header type="icon-link" title="Cobrar via divisão" navigateTo={`transacoes/${transactionId}`}
                        icon="back"/>
                <Form
                ...
                <li key={item.id}>
                  ...
                  >
                    <label style={{ fontFamily: fontTitle, width: '500px' }}>
                      ...
                      <Button submitting={loadingButton} type="button" cta="Remover"
                              click={() => deleteSplit(item.id, item)} template="regular"/>
                  </div>
                    <hr/>
                </li>
              ))}
