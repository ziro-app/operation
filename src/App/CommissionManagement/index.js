...
const ComissionManagement = () => {
    const [overviewData, setOverviewData] = useState(graphBasicConfig(arrayMonth()))
    ...
    const state = {setIsLoading, setError, setSeries, setSectores, sector, setData, data}
    ...
    useEffect(() => fetchGraph(state),[sector])
