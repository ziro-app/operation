        ...
        if (effectTransaction[0]) {
            ...
            if (
                ...
                const installmentsNumber = parseInt(
                    effectTransaction[0].installments
                );
                    ...
                    block = [
...

                        {
                            ...
                            body: [
                                {
                                    title: "Bandeira",
                                    content: effectTransaction[0].brand
                                        ? effectTransaction[0].brand
                                        : "-",
                                },
                                {
                                    title: "Número",
                                    content: effectTransaction[0].firstFour
                                        ? `${effectTransaction[0].firstFour}...${effectTransaction[0].lastFour}`
                                        : "-",
                                },
                                {
                                    title: "Portador",
                                    content: effectTransaction[0].cardholder
                                        ? effectTransaction[0].cardholder.toUpperCase()
                                        : "-",
                                },
                            ],
                        },
            ...
            <div style={{ display: "grid", gridRowGap: "40px" }}>
                ...
                {(transaction.status === "Aprovado" ||
                    ...
                    <>
                        ...
                        />
                        <span style={{ fontFamily: "Rubik", fontSize: "12px" }}>
                            * Os valores das parcelas foram arredondados para a
                ...
                {(transaction.status === "Cancelado" ||
                    ...
                    <div style={illustrationContainer}>
                        ...
                        >
                            ...
                            <span style={custom(15, transaction.statusColor)}>
                                Pagamento cancelado.
                            </span>
                        </div>
                    </div>
                ...
                {(transaction.status === "Aguardando Pagamento" ||
                    transaction.status === "Aprovação Pendente") && (
                    <>
                        <div style={illustrationContainer}>
                            <div
                                style={{
                                ...
                                >
                                    ...
                                    >
                                        <label style={modalLabel}>
                                            Deseja realmente cancelar o link ?
                                        </label>
                                        <div
                                            style={{
                                                display: "grid",
